...
import { deleteUser, getUserById } from "@/app/actions/userActions";
...
// ฟอร์มยืนยันการลบ
export default async function DeleteUserPage({ params }: DeletePageProps) {
  const { id } = params;
  ...
  return (
    <main style={containerStyle}>
      <div style={boxStyle}>
        <h1 style={titleStyle}>ยืนยันการลบข้อมูลผู้ใช้</h1>
        ...
        <form action={handleDelete} style={{ display: "flex", justifyContent: "center" }}>
          ...
          <a href="/admin" style={cancelButtonStyle}>
            ❌ ยกเลิก
          </a>
        </form>
      </div>
